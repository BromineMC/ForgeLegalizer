...
- Latest release, that is published to GitHub and/or Modrinth.
...
publicly, report it via the "Security" tab on GitHub. Please note that this modification and plugin is developed free
of charge in my free time, so please give me a bit to respond. If you can't or don't want to use GitHub Security Tab,
